<footer class="header__footer">
    <div class="container p-5">
          ...
          <div class="col-lg-6 footer__text__contact">
            ...
            <div class="mb-2">
              <a href="https://www.instagram.com/bso_hmjti/" class="">
                  ...
                  <p class=" align-self-center p-0 m-0">&nbsp bso_hmjti</p>
                </div>
              </a>
            </div>
            <div class="mb-2">
              <a href="mailto:bso.hmjti@gmail.com">
                <div class="d-flex">
                  ...
                  <p class=" align-self-center p-0 m-0">&nbsp bso.hmjti@gmail.com</p>
                </div>
              </a>
            </div>
            <div class="mb-2">
              <a href="https://wa.me/083846997665">
                <div class="d-flex">
                  ...
                  <p class=" align-self-center p-0 m-0">&nbsp 0838-4699-7665 [Perhubungan]</p>
                </div>
              </a>
            </div>
        ...
        <div class="row mt-5">
            <div class="col-lg-8">
                <p>	&copy; Copyright BSO HMJTI 2020</p>
            </div>
            <div class="col-lg-4 d-flex justify-content-end copyright__text">
                <p>Dikembangkan Oleh : </p> <a href="#"  data-bs-toggle="modal" data-bs-target="#dev" class="fw-bold">&nbsp BSO HMJTI DEV</a>
            </div>
        </div>
    </div>
</footer>
