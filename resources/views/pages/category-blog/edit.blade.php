    ...
    <div class="animated fadeIn">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('category-blogs.update',$data->id) }}" method="post" class="form-horizontal">
                            @csrf
                            @method('PUT')
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="hf-ktblog" class=" form-control-label">Kategori Blog</label></div>
                                <div class="col-12 col-md-9">
                                    <input type="text" id="hf-ktblog" name="ktblog" placeholder="Masukkan Kategori Blog..." class="form-control @error('ktblog') is-invalid @enderror" value="{{ $data->category_name }}">
                                    @error('ktblog')
