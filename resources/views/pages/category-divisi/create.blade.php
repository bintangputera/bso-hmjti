    ...
    <div class="animated fadeIn">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('category-division.store') }}" method="post" class="form-horizontal">
                            @csrf
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="hf-ktdivisi" class=" form-control-label">Kategori Divisi</label></div>
                                <div class="col-12 col-md-9">
                                    <input type="text" id="hf-ktdivisi" name="ktdivisi" placeholder="Masukkan Kategori Divisi..." class="form-control @error('ktdivisi') is-invalid @enderror" >
                                    @error('ktdivisi')
                            ...
                            <div class="row form-group mt-4">
                                ...
                                <div class="col-12 col-md-9"><input type="text" id="hf-desc" name="desc" placeholder="Masukkan Deskripsi Singkat..." class="form-control @error('desc') is-invalid @enderror">
                                    @error('desc')
                                    <div class="invalid-feedback">
                                        <small class="help-block form-text text-danger" >{{$message}}</small>
                                    </div>
