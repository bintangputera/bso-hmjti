...
@section('content')
    ...
    <div class="content">
        ...
        <div class="animated fadeIn">
            <div class="row">
                <div class="col-sm-12">
                    <a href="{{ route('category-division.create') }}">
                                ...
                                <tbody>
                                    @forelse ($data as $item)
                                        <tr>
                                            ...
                                            <td>{{ ucwords($item->divisi_name ) }}</td>
                                            <td>{{ $item->desc  }}</td>
                                            <td>
                                                <div class="d-flex">
                                                    <div class="p-1">
                                                        <a href="{{ route('category-division.edit',$item->id) }}" class="btn btn-warning"><i class="ti-pencil-alt"></i></a>
                                                    </div>
                                                    <div class="p-1">
                                                        <form action="{{ route('category-division.destroy',$item->id) }}" method="POST">
                                                            @method('delete')
                                                            @csrf
