<!DOCTYPE html>
  <html lang="en">
    ...
    <body>
      <header>
        <nav class="navbar-1-1 navbar navbar-expand-lg navbar-light p-4 px-md-4 mb-1 bg-body"
          style="font-family: Poppins, sans-serif">
          <div class="container">
            <a class="navbar-brand" href="#">
              <div class="d-flex">
                <img src=" {{ asset('frontend/assets/images/logo.png') }}" alt="logo BSO HMJTI"  width="60" class="img-fluid">
                <div class="row d-inline-block align-text-top pt-2">
                    <h2 style="font-size: 1rem; font-weight: 600;"> Badan Semi Otonom <br> HMJTI-Kampus Bondowoso</h2>
                </div>
                  ...
                  <div class="card">
                    <div class="card-body header__ketua">
                      <div class="d-flex justify-content-center">
                        <img src=" {{ asset('assets/images/ketua-wakil.jpg') }}" class="img-fluid w-50 mx-auto" alt="">
                      </div>
                      <div class="container">
                ...
                <div class="col-lg-6 col-sm-12">
                  <div class="row g-0 overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                    <div class="col p-4 d-flex flex-column position-static">
                      ...
                      <div class="mb-1 text-muted" style="font-size: 12px;">Rifjan Jundila | 12 November 2021</div>
                      <p class="card-text mb-4 mt-3">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Doloremque cupiditate, animi temporibus quas similique aliquam qui sequi, recusandae harum quos, sunt natus. Officia dolor eveniet quae non placeat. Atque, voluptas.</p>
                      <div class="d-flex justify-content-start">
                        <a href="#" class="btn btn-primary">Continue reading</a>
                      </div>
                    </div>
                    <div class="col-auto d-none d-lg-block">
                      <img src=" {{ asset('frontend/assets/images/blog.jpg') }}" class="h-100" width="250"  alt="" srcset="">
                    </div>
                  </div>
                </div>
            </div>
        ...
        <div class="container p-5">
            <div class="row">
              <div class="col-lg-12 d-flex justify-content-start">
                <div class="p-2">
                  <img src=" {{ asset('frontend/assets/images/logo_putih.png') }}" alt="logo putih" class="img-fluid" width="50">
                </div>
                <div class="p-2">
                  <img src=" {{ asset('frontend/assets/images/polije.png') }}"  class="img-fluid" width="290" alt="logo polije">
                </div>
              </div>
              <div class="col-lg-12">
                <hr>
              ...
              <div class="col-lg-6 footer__text__contact">
                ...
                <div class="mb-2">
                  <a href="" class="">
                      ...
                      <p class=" align-self-center p-0 m-0">bso_hmjti</p>
                    </div>
                  </a>
                </div>
                <div class="mb-2">
                  ...
                  <a href="">
                    <div class="d-flex">
                      <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                        width="24" height="24"
                        viewBox="0 0 172 172"
                        style=" fill:#000000;"><g fill="none" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt" stroke-linejoin="miter" stroke-miterlimit="10" stroke-dasharray="" stroke-dashoffset="0" font-family="none" font-weight="none" font-size="none" text-anchor="none" style="mix-blend-mode: normal"><path d="M0,172v-172h172v172z" fill="none"></path><g fill="#ffffff"><path d="M57.33333,28.66667l71.66667,14.33333h7.16667c11.87517,0 21.5,9.62483 21.5,21.5v71.66667c0,11.87517 -9.62483,21.5 -21.5,21.5h-71.66667c-11.87517,0 -21.5,-9.62483 -21.5,-21.5v-7.16667l-14.33333,-71.66667z" opacity="0.35"></path><path d="M129,35.83333v7.16667h-64.5c-11.89667,0 -21.5,9.60333 -21.5,21.5v64.5h-7.16667c-11.89667,0 -21.5,-9.60333 -21.5,-21.5v-71.66667c0,-11.89667 9.60333,-21.5 21.5,-21.5h71.66667c11.89667,0 21.5,9.60333 21.5,21.5z"></path><path d="M131.8165,110.84683c-5.79783,-5.79783 -15.2005,-5.79783 -20.99833,0l-3.698,3.698l-20.99833,-20.99833l3.698,-3.698c5.79783,-5.79783 5.79783,-15.2005 0,-20.99833c-5.79783,-5.79783 -15.2005,-5.79783 -20.99833,0c-3.70517,3.70517 -5.01667,8.8795 -3.98467,13.64533c0.8815,6.58617 4.343,21.70783 17.98117,35.346c13.63817,13.63817 28.75983,17.09967 35.346,17.98117c4.76583,1.032 9.94017,-0.2795 13.64533,-3.98467c5.805,-5.79783 5.805,-15.19333 0.00717,-20.99117z"></path></g></g></svg>
                      <p class=" align-self-center p-0 m-0">0838-4699-7665 [Perhubungan]</p>
                    </div>
                  </a>
                </div>
